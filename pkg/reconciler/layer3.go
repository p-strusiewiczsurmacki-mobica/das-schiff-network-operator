...
func (r *NodeNetworkConfigReconciler) fetchNodeConfig(ctx context.Context) (*networkv1alpha1.NodeNetworkConfig, error) {
...
func (r *NodeNetworkConfigReconciler) reconcileLayer3(l3vnis []networkv1alpha1.VRFRouteConfigurationSpec, taas []networkv1alpha1.RoutingTableSpec) error {
...
func (r *NodeNetworkConfigReconciler) configureFRR(vrfConfigs []frr.VRFConfiguration, reloadTwice bool) error {
...
func (r *NodeNetworkConfigReconciler) reloadFRR() error {
...
func (r *NodeNetworkConfigReconciler) createVrfConfigMap(l3vnis []networkv1alpha1.VRFRouteConfigurationSpec) (map[string]frr.VRFConfiguration, error) {
...
func (r *NodeNetworkConfigReconciler) reconcileL3Netlink(vrfConfigs []frr.VRFConfiguration) ([]nl.VRFInformation, bool, error) {
...
func (r *NodeNetworkConfigReconciler) reconcileTaasNetlink(vrfConfigs []frr.VRFConfiguration) (bool, error) {
...
func (r *NodeNetworkConfigReconciler) cleanupTaasNetlink(existing []nl.TaasInformation, intended []frr.VRFConfiguration) (bool, error) {
...
func (r *NodeNetworkConfigReconciler) createTaasNetlink(existing []nl.TaasInformation, intended []frr.VRFConfiguration) error {
	for i := range intended {
		alreadyExists := false
		for _, cfg := range existing {
			if intended[i].Name == cfg.Name && intended[i].VNI == cfg.Table {
...
func (r *NodeNetworkConfigReconciler) reconcileExisting(cfg nl.VRFInformation) error {
