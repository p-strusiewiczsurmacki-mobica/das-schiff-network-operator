...
func (r *NodeNetworkConfigReconciler) reconcileLayer2(l2vnis []networkv1alpha1.Layer2NetworkConfigurationSpec) error {
...
func (r *NodeNetworkConfigReconciler) createL2(info *nl.Layer2Information, anycastTrackerInterfaces *[]int) error {
...
func (r *NodeNetworkConfigReconciler) getDesired(l2vnis []networkv1alpha1.Layer2NetworkConfigurationSpec) ([]nl.Layer2Information, error) {
...
func (r *NodeNetworkConfigReconciler) reconcileExistingLayer(desired, currentConfig *nl.Layer2Information, anycastTrackerInterfaces *[]int) error {
